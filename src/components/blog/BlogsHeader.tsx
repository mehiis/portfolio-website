  ...
  return (
    <header className="py-2 items-center bg-[var(--secondary-color)] text-[var(--black-color)] shadow-sm mb-8">
      <div className="max-w-[1440px] min-w-[360px] m-auto px-10 py-5 md:px-40">
        ...
        <p className="py-2 font-[LeagueSpartanRegular] text-md 2xl:text-lg">Collection of blog posts & projects. There is currently {Articles.length} written blog posts.</p>
        </div>
    </header>
  )
}
