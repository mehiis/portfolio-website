function Hero() {
  return (
    <>
      <section className="py-10 items-center bg-(--primary-color) px-0 shadow-sm 2xl:py-20">
        <div
          ...
          <p className="text-xl 2xl:text-2xl font-[LeagueSpartanRegular] bg-(--white-color) text-(--black-color) shadow-sm rounded-lg my-auto  mx-10 p-8">
