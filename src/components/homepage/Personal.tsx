...
import h2sm from "@/assets/images/h2/personal-project/pp-sm.webp";
import h2lg from "@/assets/images/h2/personal-project/pp-lg.webp";
...
const Personal = () => {
    return(
        <div className="max-w-[1440px] min-w-[360px] mx-auto p-2 md:px-30">
            <CustomH2Title sourceSm={h2sm} sourceLg={h2lg} alt="Personal Projects" />
