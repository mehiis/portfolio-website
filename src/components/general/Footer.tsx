        ...
        <footer className='mt-0'>
            <div className='bg-[var(--primary-color)] p-15 justify-center items-center min-w-[360px] pb-25'>
                ...
                <div className='flex justify-center'>
                    <a href="https://github.com/mehiis" target="_blank"><img src={github} loading="lazy" alt="GitHub Logo 2025" className="w-8 h-auto mx-3 hover:scale-115 transition-transform duration-150" /></a>
                    ...
                    <a href="https://www.instagram.com/nikomehilainen/" target="_blank"><img src={instagram} loading="lazy" alt="Instagram Logo 2025" className="w-8 h-auto mx-3 hover:scale-115 transition-transform duration-150" /></a>
                </div>
            </div>
        </footer>
  )
