  ...
  return (
    <div className="bg-[var(--primary-color)] px-8 py-4 rounded-xl shadow-sm">
        <div className="items-center md:grid md:grid-cols-[260px_1fr]">
            <img src={props.icon} alt={"Icon of the project " + props.title} className="w-auto max-h-[65px] md:max-h-[90px] mb-3 md:mb-0 object-contain mx-auto"/>
            <div className="text-[var(--black-color)] p-4">
                ...
                <div className="mt-4 md:justify-between md:flex md:items-end">
                    <div className="flex flex-wrap gap-1">
                        ...
                        <div className="mt-5 md:mt-0 bg-[var(--secondary-color)] text-sm text-[var(--black-color)] inline-block px-4 py-2 rounded-lg hover:scale-110 transition-transform duration-300 shadow-sm flex-none max-h-[40px]">
                                Read more &#10230;
                        </div>
                </div>
            </div>
