    ...
    <div className="bg-[var(--primary-color)] px-8 py-4 rounded-xl shadow-sm">
        <div className="items-center md:grid md:grid-cols-[260px_1fr]">
            ...
            <div className="text-[var(--black-color)] p-4">
                ...
                <p className="text-md 2xl:text-lg mt-4 font-[arial]">{props.description}</p>

                <div className="mt-4 md:justify-between md:flex md:items-end">
                    <div className="flex flex-wrap gap-1">
                        <p className="text-sm 2xl:text-md mt-2 md:mt-0">Created using:</p>
                        ...
                        <div className="mt-5 md:mt-0 bg-[var(--secondary-color)] text-sm 2xl:text-md text-[var(--black-color)] inline-block px-4 py-2 rounded-lg hover:scale-110 transition-transform duration-300 shadow-sm flex-none max-h-[40px]">
                                Read more &#10230;
                        </div>
                </div>
            </div>
