...
const CustomProjectView = ({id, title, description, year, tech, image}: Props) => {
  return (
    <div className="bg-[var(--primary-color)] p-8 text-shadow-sm rounded-xl">
        <div className=" items-center md:grid md:grid-cols-[260px_1fr]">
            ...
            <div className="text-[var(--black-color)] p-4">
                ...
                <Link to={`/project/${id}`} className="bg-[var(--secondary-color)] text-md text-[var(--black-color)] px-4 py-2 rounded-lg hover:scale-105 transition-transform duration-200 mt-5 inline-block">
